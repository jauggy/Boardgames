              ...
              $.ajax({
                  ...
                  success: function (data) {
                      ...
                      $(hexes).each(function (index, item) {
                          var callback = function () { HideMainActions(); GetExploreToHexes(item); return false; };
          ...
          function GetExploreToHexes(hex) {
              ...
              $.ajax({
                  ...
                  success: function (data) {
                      ...
                      HideTempMenus();
                      $(hexes).each(function (index, item) {
                          var callback = function () { ExploreTo(item); return false;};
    ...
    <div style="display:none">
        ...
        <div id="tempMenu" style="position:absolute">
          ...
          <div id="exploreFromDiv" style="display:none; background-color:white" class="explore">
            <div class="btn-group-vertical">
               <button onclick="return false;" type="button" class="btn btn-primary explorebutton">Explore from</button>
